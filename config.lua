config = {
	...
	bankcoords = {
		...
		{name = "Pacific Bank Robbery", alarm = "^1^*A silent alarm has been triggered at the ^5Bank in Vinewood PAC Bank^1! All police units are required to assist!", 
		x = 254.24, y = 225.08, z = 101.87 - 1},
	},
